  ...
  return (
    <div className="content-wrapper">
      <div className="content">
        <Button button_class="content-button">
          <span>
            <svg
        ...
        <TitleText title_class="main_title_text">
        ...
        <div className="underneath-buttons-wrapper">
          <Button button_class="start-free-trial">Start free trial</Button>
          <Button button_class="learn-more">Learn more</Button>
        </div>
      </div>
      <div className="picture-wrapper">
        <Logo logo_src="assets/image 1.png" logo_alt="" />
      </div>
    </div>
  );
}
