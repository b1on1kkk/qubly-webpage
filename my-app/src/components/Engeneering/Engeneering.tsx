import "./Engeneering.css";

import InformationBlock from "../InformationBlock/InformationBlock";
import Logo from "../Logo/Logo";

export default function Engeneering(): JSX.Element {
  return (
    <div className="for-engeneeries-inf">
      <InformationBlock
        svg_path={
          <svg
        ...
        button_title_text="For Engineering Teams"
        title_text="Data-driven pipelines in minutes"
      ...
      />
      <Logo logo_src="assets/image 9.png" logo_alt="engeneering logo"></Logo>
    </div>
  );
}
